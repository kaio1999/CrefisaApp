...
import * as S from "./BusinessHour.style";
...
const BusinessHour = () => {
  ...
  const optionsDays = [
    {
      days: "Manhã (9h às 12h)",
      id: 0,
    },
    {
      days: "Manhã (14h às 17h)",
      id: 1,
    },
    {
      days: "Manhã (18h às 21h)",
      id: 2,
    },
  ];
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View>
        <S.Content style={{ height: "100%" }}>
          ...
          <S.Title>Qual é o horário de funcionamento do seu negócio?</S.Title>
